...
const knownComponentClasses = new Set(["pd-badge","pd-badge--accent","pd-badge--danger","pd-badge--info","pd-badge--interactive","pd-badge--success","pd-badge--warning","pd-button","pd-button--pill","pd-card","pd-card--interactive","pd-divider","pd-divider--vertical","pd-field","pd-field--error","pd-field__icon","pd-field__label","pd-field__message","pd-input","pd-input--error","pd-nav","pd-nav__link","pd-nav__link--active","pd-nav__list"]);
